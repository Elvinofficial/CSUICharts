...
{
    public static class ConnectionEndpointDragBehavior
    {
        public static readonly DependencyProperty InteractionCanvasProperty =
            DependencyProperty.RegisterAttached(
                "InteractionCanvas",
                typeof(Canvas),
                typeof(ConnectionEndpointDragBehavior),
        ...
        private static void OnMouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            GetMouseDownCommand(element)?.Execute(connection);
        ...
        private static void OnMouseUp(object sender, MouseButtonEventArgs e)
        {
            ...
            GetMouseUpCommand(element)?.Execute(e.GetPosition(canvas));
